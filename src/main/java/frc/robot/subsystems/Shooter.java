...
private WPI_TalonFX shooterFalcon;
    ...
    private final double kI =0.0006;
    private final double kD =40;
...
shooterFalcon = new WPI_TalonFX(7);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        shooterFalcon.config_IntegralZone(0, 2000);
        shooterFalcon.configClosedloopRamp(.3);
    ...
    // }
    public void shootAtRPM_PID(){
        setShooter(ControlMode.Velocity, setRPM*kSensorUnitsPerRotation/600);
    }
