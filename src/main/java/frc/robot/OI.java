...
bButtonAutoAlign.whileHeld(new AutoAlign());
        ...
        SmartDashboard.putData("shootFast", new SixBallAutoRT());
        ...
        SmartDashboard.putData("Start_Shooter", new Start_Shooter_RPM(4270));
        ...
        // SmartDashboard.putData("SalamPath", new SalamPath());
        // SmartDashboard.putData("bouncePath", new bouncePath());
        // SmartDashboard.putData("SetStartPoint", new SetStartPoint());

    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
         SmartDashboard.putBoolean("FancyRemote",true);
