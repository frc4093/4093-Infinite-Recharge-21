...
public class GoTo extends CommandGroup {
   ...
   private double distance;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
        ...
        double xOffsetFromRobot = (currentX-x)+.00000001; //if we think of robot at (0,0) then where is x. .0001 is added to force triangle to exist
        double yOffsetFromRobot = (currentY-y)+.00000001;//if we think of robot at (0,0) then where is y. 
